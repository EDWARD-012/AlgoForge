...
import { Loader2, Mail, Lock, Code2, Eye, EyeOff } from 'lucide-react';
    ...
    <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-primary)' }}>Welcome back</h1>
          <p style={{ margin: '6px 0 0', fontSize: '0.875rem', color: 'var(--text-muted)' }}>Sign in to continue your DSA journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            {loading ? <Loader2 style={{ width: '16px', height: '16px', animation: 'spin 1s linear infinite' }} /> : 'Log In'}
          </motion.button>
        </form>
